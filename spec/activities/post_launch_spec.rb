...
describe 'post_with_session Launch Activity' do
  ...
  it "should allow testing for a paramter" do
    fake_launch
    get_with_session "/launch/post_launch/0"
    post_with_session "/test/post_launch/0", {'launch_url' => 'http://www.example.com/launch'}
  ...
  it "should allow testing custom fields if a value is provided" do
    ...
    get_with_session "/launch/post_launch/11", {}
    post_with_session "/test/post_launch/11", {'launch_url' => 'http://www.example.com/launch'}
    post_with_session "/validate/post_launch/11", {'answer' => session["answer_for_post_launch_11"]}
    json = JSON.parse(last_response.body)
    json['correct'].should == true
  end
  ...
  describe "role picking" do
    it "should succeed when correct roles are picked" do
      fake_launch({'farthest_for_post_launch' => 20})
      get_with_session "/launch/post_launch/5", {}
      ...
      post_with_session "/validate/post_launch/5", {'role' => roles}
      json = JSON.parse(last_response.body)
      json['correct'].should == true
    end
    ...
    it "should fail when answer is set but not roles" do
      ...
      post_with_session "/test/post_launch/5", {'launch_url' => 'http://www.example.com/launch'}
      answer = session["answer_for_post_launch_5"]
      post_with_session "/validate/post_launch/5", {'answer' => answer}
      json = JSON.parse(last_response.body)
      json['correct'].should == false
    end
    ...
    it "should fail when correct roles are not picked" do
      ...
      get_with_session "/launch/post_launch/5", {}
      post_with_session "/test/post_launch/5", {'launch_url' => 'http://www.example.com/launch'}
      post_with_session "/validate/post_launch/5", {'role' => ['a', 'b']}
      json = JSON.parse(last_response.body)
      json['correct'].should == false

      post_with_session "/validate/post_launch/5", {'role' => "a"}
      json = JSON.parse(last_response.body)
      json['correct'].should == false
    end
  end

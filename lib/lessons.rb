module Sinatra
  module Lessons
    ...
    post '/oauth_start/:activity/:index' do
      load_user_and_activity
    ...
    get '/api/v1/secret/:activity/:index/:user_id/:code' do
      load_user_and_activity
    ...
    post '/preflight/:activity/:index/:user_id/:code' do
      load_user_and_activity
    ...
    post '/api/v1/file_upload/:user_id/:code' do
      load_user(true)
    ...
    post '/api/v1/file_finalize/:user_id/:code' do
      load_user
      @user.settings ||= {}
      @user.settings["settings_for_file_upload"] = {
        :id => rand(99999),
    ...
    get '/api/v1/file_status/:user_id/:code' do
      load_user
      ...
      if opts['lookups'] <= 1
        if opts['error']
          msg = UPLOAD_ERROR_MESSAGES[opts['message_index']]
          {
            :upload_status => 'error',
            :message => msg
          }.to_json
